# Miten peliin saa ääniä?

## Taustamusiikki

Taustamusiikin soittamista varten täytyy ihan ensimmäisenä tuoda taustamusiikiksi haluttu tiedosto mukaan projektiin. Taustamusiikin **tulee olla wav-tiedosto**. Liitä tiedostosi projektiin käyttämällä apuna ohjeita [sisällön tuomisesta](../muut/sisallon-tuonti.md).
...
Kun äänitiedosto on olemassa, se pitää vielä liittää projektiin. Katso sitä varten ohjeet [sisällön tuomisesta](../muut/sisallon-tuonti.md). **Äänen täytyy olla .wav-tiedosto.** Kun äänitiedosto on liitetty projektiin, ääni on valmis soitettavaksi seuraavilla tavoilla:
