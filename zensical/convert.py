...
NEST_UNDER: dict[str, str] = {}  # jypelidocs: ei siirrettäviä sivuja (ohj1: tenttiohjeet, git-ht-ohje)
...
DROP_SECTIONS: dict[str, str] = {}  # jypelidocs: ei poistettavia osioita (ohj1: index.md:n navigointiosio)
...
PLANTUML_AGENT = "jypelidocs-zensical"
